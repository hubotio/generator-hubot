...
<%= botName %> is a chatbot built on the [Hubot][hubot] framework. It was initially created by [generator-hubot][generator-hubot], and configured to be deployed on [Heroku][heroku] to get you up and running as quick as possible.
